...
const views = [
  ...
  ['costos', 'Centros de costo', Building2], ['operacion', 'Caja y comprobantes', CircleDollarSign], ['cierre-caja', 'Cierre de caja', LockKeyhole],
] as const;
